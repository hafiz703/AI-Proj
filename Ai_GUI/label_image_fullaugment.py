...
class LabelImage():
    ...
    def run(self):
        ...
        img_name = os.path.splitext(self.image_path)[0]
        augmented_images = augment.augment_image(img_name)
        ...
        return label_lines, np.average(predictions,axis=0)
...
# python label_image_fullaugment.py SOB_B_TA-14-21978AB-100-017_train.jpg retrained_graph_8.pb retrained_labels_8.txt
